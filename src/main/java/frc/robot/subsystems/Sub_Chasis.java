...
*/
  ...
  public Sub_Chasis() {
   ...
   // MasterLeftMotor.configFactoryDefault();  SlaveLeftMotor.configFactoryDefault();
    ...
    SlaveLeftMotor.follow(MasterLeftMotor); SlaveRightMotor.follow(MasterRightMotor);
    ...
    MasterLeftMotor.setIdleMode(IdleMode.kBrake); SlaveLeftMotor.setIdleMode(IdleMode.kBrake);
    MasterRightMotor.setIdleMode(IdleMode.kBrake);MasterLeftMotor.setIdleMode(IdleMode.kBrake);
   ...
   // SetOpenLoopedS(0);
    ...
    EncoderL.setPosition(0); EncoderR.setPosition(0);
    EncoderL.setPositionConversionFactor((6/Math.PI)/(1/10.71));
    EncoderR.setPositionConversionFactor((6/Math.PI)/(1/10.71));
  ...
  public void periodic() { 
    ...
    SmartDashboard.putNumber("V", Volts);
...
*/
  public void SetOpenLoopedSN(double S){
    MasterRightMotor.setClosedLoopRampRate(S); MasterLeftMotor.setClosedLoopRampRate(S);
    SlaveRightMotor.setClosedLoopRampRate(S); SlaveLeftMotor.setClosedLoopRampRate(S);
  }
